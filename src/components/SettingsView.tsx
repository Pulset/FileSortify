...
const SettingsView: React.FC = () => {
  ...
  const handleCheckForUpdates = async () => {
    ...
    try {
      const updateStatus = await invoke('check_update');
      ...
      <div className="settings-content" style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              <span className="text-sm font-medium text-gray-700">构建日期</span>
              <span className="text-sm text-gray-600">2024-08-04</span>
            </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">应用启动时自动隐藏到系统托盘</p>
              </div>
              <input
                type="checkbox"
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="text-sm text-gray-600 space-y-2">
            <p>
              File Sortify 是一个智能的文件自动分类工具，可以根据文件类型自动整理您的文件。
            </p>
            <p>
