    ...
    <div className="view active">
      ...
      <div className="dashboard-grid">
        ...
        <div className="stat-card">
          ...
          <div className="stat-content">
            <div className="stat-number">{isMonitoring ? '监控中' : '已停止'}</div>
      ...
      <div className="quick-actions">
        ...
        <div className="action-buttons">
          <button className="action-btn primary" onClick={onOrganizeFiles}>
            ...
            <div className="btn-text">
              ...
              <div className="btn-desc">整理现有文件</div>
            </div>
          </button>
          ...
          <button className="action-btn secondary" onClick={onToggleMonitoring}>
            ...
            <div className="btn-text">
              <div className="btn-title">{isMonitoring ? '停止监控' : '开始监控'}</div>
              <div className="btn-desc">自动监控新文件</div>
            </div>
          </button>
        </div>
      </div>
